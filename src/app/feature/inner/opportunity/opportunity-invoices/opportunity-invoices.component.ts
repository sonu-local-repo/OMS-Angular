...
@Component({
  selector: 'app-opportunity-invoices',
  templateUrl: './opportunity-invoices.component.html',
  styleUrls: ['./opportunity-invoices.component.scss']
})
export class OpportunityInvoicesComponent implements OnInit {
...
export class OpportunityInvoicesComponent {
  form: FormGroup;
  customer_info = {
    name: 'Mr. John Doe',
